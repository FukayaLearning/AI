...
| チップ名 | メモリ帯域幅 | 最大搭載メモリ (UMA) | 割り当て可能VRAM目安 | 動作可能な最大モデル規模 (Q4〜Q8) |
| :--- | :--- | :--- | :--- | :--- |
| **M4 / M3 (Base)** | 100〜150 GB/s | 24GB〜32GB | 約 20GB〜24GB | 8B (Q8), 14B (Q4) |
| **M4 Pro / M3 Pro** | 150〜273 GB/s | 36GB〜64GB | 約 30GB〜50GB | 14B (Q8), 32B (Q4) |
| **M4 Max / M3 Max** | 300〜**546 GB/s** | 64GB〜**128GB** | 約 50GB〜**100GB** | **70B (Q4: Llama 3.3 70B)** |
| **M2 Ultra / M3 Ultra** ⭐ | **800 GB/s** | **128GB〜192GB+** | 約 100GB〜**160GB+** | **70B (Q8/FP16), 120B, 大型MoE** |
