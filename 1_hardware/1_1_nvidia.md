...
=== "コンシューマ向け (GeForce RTX)"
    ...
    | モデル名 | アーキテクチャ | VRAM容量・メモリ規格 | メモリ帯域幅<br>(ピン伝送速度 / バス幅) | FP16/FP8 演算性能 | 実売/想定価格帯 | 動作可能なモデル規模 (Q4〜Q8) |
    | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
    | **RTX 4070 Ti Super** | Ada Lovelace | **16GB** GDDR6X | **672 GB/s** (21 Gbps / 256-bit) | 44 TFLOPS | 12〜14万円 | 8B (Q8/FP16), 14B (Q4) |
    | **RTX 4080 (Super)** | Ada Lovelace | **16GB** GDDR6X | **736 GB/s** (23 Gbps / 256-bit) | 52 TFLOPS | 15〜19万円 | 8B (Q8/FP16), 14B (Q4) |
    | **RTX 4090** ⭐ | Ada Lovelace | **24GB** GDDR6X | **1,008 GB/s** (21 Gbps / 384-bit) | 83 TFLOPS | 30〜38万円 | **14B〜32B (Q4/Q8), DeepSeek-R1-Distill-32B** |
    | **RTX 5080** | Blackwell | **16GB** GDDR7 | **1,024 GB/s** (32 Gbps / 256-bit) | 次世代 | 18〜23万円 | 8B〜14B (超高速推論) |
    | **RTX 5090** ⭐ | Blackwell | **32GB** GDDR7 | **1,792 GB/s** (28 Gbps / 512-bit) | 次世代 | 35〜45万円 | **32B (Q8), 小型MoE, 70B (超軽量量子化)** |

=== "プロフェッショナル向け (RTX Ada / Aシリーズ)"
    静音性・省電力性・複数枚差し（マルチGPU）適性・ECCメモリによる信頼性を重視したワークステーション向けシリーズです。

    | モデル名 | VRAM容量・メモリ規格 | メモリ帯域幅<br>(ピン伝送速度 / バス幅) | 消費電力 (TDP) | 実売価格帯 | 主な特徴・用途 |
    | :--- | :--- | :--- | :--- | :--- | :--- |
    | **RTX 4000 Ada SFF** | **20GB** GDDR6 (ECC) | **280 GB/s** (14 Gbps / 160-bit) | **70W** (超省電力) | 20〜25万円 | ロープロファイル対応。小型PC・常時稼働推論サーバーに最適 |
    | **RTX 4000 Ada** | **20GB** GDDR6 (ECC) | **360 GB/s** (18 Gbps / 160-bit) | 130W | 22〜26万円 | 1スロット薄型設計。複数枚差しでのスケールアウトが容易 |
    | **RTX 5000 Ada** | **32GB** GDDR6 (ECC) | **576 GB/s** (18 Gbps / 256-bit) | 250W | 60〜75万円 | 32Bモデルを余裕でロード、安定した長時間の学習・推論 |
    | **RTX A6000 (Ampere)** | **48GB** GDDR6 (ECC) | **768 GB/s** (16 Gbps / 384-bit) | 300W | 65〜80万円 (中古40万~) | **48GB大容量**。70B Q4モデルを1枚でロード可能（コスパ高） |
    | **RTX 6000 Ada** | **48GB** GDDR6 (ECC) | **960 GB/s** (20 Gbps / 384-bit) | 300W | 110〜140万円 | Ada世代最高峰。70Bモデル推論・LoRA学習を高速処理 |

=== "データセンター向け (Hopper / Blackwell)"
    クラウド事業者や大規模企業AIクラスタ向けの最上位アクセラレータです。

    | モデル名 | VRAM容量 | メモリ規格・帯域幅<br>(伝送速度 / バス幅) | 相互接続 (NVLink) | 主な用途 |
    | :--- | :--- | :--- | :--- | :--- |
    | **H100 SXM5** | 80GB HBM3 | **3,350 GB/s** (5.2 Gbps / 5120-bit) | 900 GB/s (4ポート) | 業界標準のLLM学習・推論インフラ |
    | **H200 SXM5** | **141GB** HBM3e | **4,800 GB/s** (6.25 Gbps / 6144-bit) | 900 GB/s | HBM3e大容量化により超長文コンテキスト・70B超推論を1枚で高速化 |
    | **B200 / GB200** | 192GB〜 HBM3e | **8,000 GB/s** (8.0 Gbps / 8192-bit) | 1,800 GB/s | Blackwell世代。第2世代Transformer Engine (FP4) による極限スループット |
